...
public class Snake extends Pet implements PetImpl {
    ...
    /**
     * Constructor
     * @param animalType {@link AnimalType} that defines if it is domesticated or wild snake
    ...
    {
        super(PetType.SNAKE, cost, gender, petStoreId); // You may want to change PetType.DOG to PetType.SNAKE if defined
